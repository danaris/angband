...
MON_TMD(BLIND,	MON_MSG_BLIND,			MON_MSG_NOT_BLIND,		MON_MSG_MORE_BLIND,		0L,				50)
MON_TMD(ENTANGLED,	MON_MSG_ENTANGLED,		MON_MSG_NOT_ENTANGLED,	MON_MSG_MORE_ENTANGLED, 0L,			50)
MON_TMD(HITADJUST,	MON_MSG_HITADJUST,		MON_MSG_NOT_HITADJUST,	0,					0L,				50)
MON_TMD(DAMADJUST,	MON_MSG_DAMADJUST,		MON_MSG_NOT_DAMADJUST,	0,					0L,				50)
