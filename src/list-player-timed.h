...
TMD(ENTANGLED,	"entanglement",		"Your legs are ensnared!",			"You are free to move once more.",					NULL,										NULL,										0,									PU_BONUS,										MSG_ENTANGLED,		1,	OF_PROT_STUN)
...
TMD(CONFUSED,	"confusion",				"You are confused!",						"You are no longer confused.",					"You are more confused!",					"You feel a little less confused.",			0,									0,												MSG_CONFUSED,	TMD_FAIL_FLAG_OBJECT,	OF_PROT_CONF)
...
TMD(IMAGE,		"hallucination",			"You feel drugged!",						"You can see clearly again.",					"You feel more drugged!",					"You feel less drugged.",					PR_MAP | PR_MONLIST | PR_ITEMLIST,	0,												MSG_DRUGGED,	TMD_FAIL_FLAG_RESIST,	ELEM_CHAOS)
TMD(POISONED,	"poisoning",				"You are poisoned!",						"You are no longer poisoned.",					"You are more poisoned!",					"You are less poisoned.",					0,									0,												MSG_POISONED,	TMD_FAIL_FLAG_RESIST,	ELEM_POIS)
...
TMD(BLESSED,	"blessing",					"You feel righteous!",						"The prayer has expired.",						"You feel more righteous!",					"You feel less righteous.",					0,									PU_BONUS,										MSG_BLESSED,	0,	0)
...
TMD(OPP_ACID,	"acid resistance",			"You feel resistant to acid!",				"You are no longer resistant to acid.",			"You feel more resistant to acid!",			"You feel less resistant to acid.",			PR_STATUS,							0,												MSG_RES_ACID,	TMD_FAIL_FLAG_VULN,	ELEM_ACID)
TMD(OPP_ELEC,	"electricity resistance",	"You feel resistant to electricity!",		"You are no longer resistant to electricity.",	"You feel more resistant to electricity!",	"You feel less resistant to electricity.",	PR_STATUS,							0,												MSG_RES_ELEC,	TMD_FAIL_FLAG_VULN,	ELEM_ELEC)
TMD(OPP_FIRE,	"fire resistance",			"You feel resistant to fire!",				"You are no longer resistant to fire.",			"You feel more resistant to fire!",			"You feel less resistant to fire.",			PR_STATUS,							0,												MSG_RES_FIRE,	TMD_FAIL_FLAG_VULN,	ELEM_FIRE)
TMD(OPP_COLD,	"cold resistance",			"You feel resistant to cold!",				"You are no longer resistant to cold.",			"You feel more resistant to cold!",			"You feel less resistant to cold.",			PR_STATUS,							0,												MSG_RES_COLD,	TMD_FAIL_FLAG_VULN,	ELEM_COLD)
TMD(OPP_POIS,	"poison resistance",		"You feel resistant to poison!",			"You are no longer resistant to poison.",		"You feel more resistant to poison!",		"You feel less resistant to poison.",		0,									0,												MSG_RES_POIS,	0,	0)
...
TMD(AMNESIA,	"amnesia",					"You feel your memories fade.",				"Your memories come flooding back.",			NULL,										NULL,										0,									0,												MSG_GENERIC,	0,	0)
...
TMD(BONUS_MOVE,	"bonus move",	"Your feet feel more nimble.",				"Your feet feel less nimble.",					"Your feet feel even nimbler!",				"Your feet feel less nimble.",				0,									PU_BONUS,										MSG_SPEED,		0,	0)
TMD(BONUS_MOVE_2X, "double bonus move",	"Your feet feel incredibly nimble.",	"Your feet feel less nimble.",					"Your feet feel even nimbler!",				"Your feet feel less nimble.",				0,									PU_BONUS,										MSG_SPEED,		0,	0)
