...
PF(SNEAK_ATTACK,     "can deal deadly blows to unsuspecting creatures",			  "Performs sneak attacks")
PF(SEE_TRAPS,        "can detect nearby traps", 								  "Automatically detects traps")
PF(EXTRA_MANA,       "gains extra mana",										  "Gains extra mana")
